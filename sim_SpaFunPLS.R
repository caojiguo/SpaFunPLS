...
setwd("~/Desktop/Supplementary Materials/SpaFunPLS")
...
c(mean(isenull100),sd(isenull100), mean(isenull500), sd(isenull500))
c(mean(ise100nn),sd(ise100nn),mean(ise500nn),sd(ise500nn))
c(mean(pmse100.spa),sd(pmse100.spa),mean(pmse500.spa),sd(pmse500.spa))
...
c(mean(ise100),sd(ise100),mean(ise500),sd(ise500))
c(mean(pmse100.spa),sd(pmse100.spa),mean(pmse500.spa),sd(pmse500.spa))